...
We used a 1-km working resolution because it represents a compromise between the coarse 10-km occurrence baseline and the finer environmental covariates, which range from 30 m to 1 km. This resolution is fine enough to identify meaningful pinch points in the landscape while avoiding the implication of precision that the occurrence evidence cannot support.
