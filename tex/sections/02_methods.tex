...
\label{sec:extent}
% Sentence starters: "The study area was defined as ..." / "We fixed the analysis extent before ..." / "All layers were aligned to ..."
...
\begin{outline}
\begin{itemize}
  \item Study area is the southern African cheetah range plus a buffered analysis extent.
  \item Fixed equal-area projection and a \cellsize\ snap grid, so every raster is
        directly comparable cell for cell.
  \item Cores derived from the historical confirmed-range baseline and held constant
        across 2012, 2016, 2020, 2024.
  \item Final network: 23 cores, 45 selected neighbouring core pairs.
\end{itemize}
\end{outline}

\subsection{Rationale for the working resolution}
\label{sec:scale}
% Sentence starters: "We used a 1-km working resolution because ..." / "This resolution represents a compromise between ..." / "To test whether results depended on scale, we ..."
...
\label{sec:cores}
% Sentence starters: "We defined a core area as ..." / "Cells were grouped into patches using ..." / "We retained only patches larger than ..."
...
\begin{outline}
We represented the 23 baseline-defined core areas as fixed nodes across all four temporal snapshots. Candidate links were defined as the union of an undirected three-nearest-neighbor graph based on Euclidean distances between core centroids and the graph’s minimum spanning tree. Removing duplicate undirected pairs yielded 45 selected core pairs. These straight-line links defined the pairs evaluated using least-cost analysis and were not interpreted as observed movement corridors.
\end{outline}

\subsection{Covariates and their temporal treatment}
\label{sec:covariates}
% Sentence starters: "The predictor layers represented ..." / "We treated a variable as dynamic when ..." / "We treated a variable as static when ..."
...
% Sentence starters: "Resistance values were assigned to represent ..." / "The terrain component was derived from ..." / "We compared alternative vegetation weights because ..."
...
\label{sec:temporal}
% Sentence starters: "We compared the same core pairs across ..." / "Absolute change was calculated as ..." / "Proportional change was calculated as ..."
...
% Sentence starters: "We considered a result robust when ..." / "A link was classified as sensitive when ..." / "Locations with low agreement were treated as ..."
