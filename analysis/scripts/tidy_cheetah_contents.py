...
ORDER = [
    ...
    "14 Connectivity cores · candidates",
    "14 Connectivity cores · selected",
    "15 Connectivity links · selected",
    "99 Other",
]
...
def destination_for(name):
    ...
    if text.startswith("core_top"):
        return "14 Connectivity cores · candidates"
    if text.startswith("cheetah_core_primary_"):
        return "14 Connectivity cores · selected"
    if text.startswith("cheetah_core_neighbor_"):
        return "15 Connectivity links · selected"
